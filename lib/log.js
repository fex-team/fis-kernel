...
exports.on = {
    ...
    debug   : function(msg){ process.stdout.write('[DEBUG] ' + msg + '\n'); },
    notice  : function(msg){ process.stdout.write('[NOTIC] ' + msg + '\n'); },
    warning : function(msg){ process.stdout.write('[WARNI] ' + msg + '\n'); },
