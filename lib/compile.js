                ...
                switch(type){
                    ...
                    case 'uri':
                        ...
                        if(info.file && info.file.isFile()){
                            ...
                            var query = (info.file.query && info.query) ? '&' + query.substring(1) : info.query;
                            ret = info.quote + info.file.getUrl(exports.settings.hash, exports.settings.domain) + query + info.quote;
                        } else {
                            ret = value;
                        }
                        break;
