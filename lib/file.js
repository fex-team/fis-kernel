...
var File = Object.derive(function(){
    ...
    iconv : function(){
        if(this._isText && this._content && this.charset !== 'utf8' && this.charset !== 'utf-8'){
            this._content = fis.util.toEncoding(this._content, this.charset);
        }
        return this;
    },
    writeTo : function(target){
        fis.util.write(target, this._content);
        return this;
    },
    getId : function(){
        return this.id;
    ...
    deliver : function(output, md5, release){
        release = release || this.release;
        if(!release){
        ...
        if(md5 == 0 || !this.useHash){
            ...
            target = fis.util(output, this.getHashRelease(release));
            fis.util.write(target, this._content);
            this.delivered.push(target);
        } else {
            target = fis.util(output, release);
